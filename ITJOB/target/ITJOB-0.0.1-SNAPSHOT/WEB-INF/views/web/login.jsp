	...
	<div class="container">
		...
		<form  class="needs-validation"
			...
			<div class="form-group">
				...
				<div class="invalid-feedback">Vui lòng nhập mật khẩu đúng định dạng.</div>
			</div>
			<div class="form-group">
				<label class="form-check-label"><input type="checkbox">
					Nhớ mật khẩu</label>
			</div>
			<button type="submit" class="btn btn-primary" style="margin-bottom: 20px;">Đăng nhập</button>
		</form>
	</div>

...
label.error {
	...
	<div class="site-section bg-light">
		<div class="container" >
			<form action='<c:url value = "/dang-bai"/>' id="myform" method="post" >
				<div class="row">
					...
					<div class="col-lg-6">
						...
						<div class="row form-group">
							...
							<div class="col-md-12 mb-3 mb-md-0">
								<textarea name="yeucaukhac" class="form-control" id = "yeucaukhac" cols="30" rows="7"></textarea>
							</div>
						</div>
						...
						<div class="row form-group" style="margin-top: 50px">
							<div class="col-md-12">
								<input type="submit" value="Đăng" id="btn_submit"
